#include <liteinfer/nccl227.h>
#include <liteinfer/tensor.h>
#include <liteinfer/utils.cuh>
#include <liteinfer/utils.h>
...
public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("liteinfer.NCCLWrapper", NCCLWrapper,
                                    tvm::ffi::Object);
