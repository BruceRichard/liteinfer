...
def _run_scheduler(args: ServerArgs, ack_queue: mp.Queue[str]) -> None:
    import torch
    from liteinfer.scheduler import Scheduler
...
def launch_server(run_shell: bool = False) -> None:
    ...
    def start_subprocess() -> None:
        ...
        from liteinfer.tokenizer import tokenize_worker
        ...
        for i in range(world_size):
            ...
            mp.Process(
                ...
                daemon=False,
                name=f"liteinfer-TP{i}-scheduler",
            ).start()
