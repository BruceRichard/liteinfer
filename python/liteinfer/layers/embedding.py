...
from liteinfer.distributed import DistributedCommunicator, get_tp_info
from liteinfer.utils import div_ceil, nvtx_annotate
...
class VocabParallelEmbedding(BaseOP):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        from liteinfer.kernel import indexing
