...
import torch
from liteinfer.core import get_global_ctx
from liteinfer.distributed import get_tp_info
from liteinfer.utils import div_even

from .base import StateLessOP
from .rotary import get_rope

if TYPE_CHECKING:
    from liteinfer.layers import RMSNorm
    from liteinfer.models import RotaryConfig
