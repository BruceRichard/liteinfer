...
RUN useradd --create-home --shell /bin/bash --uid 1001 liteinfer

# Copy application from builder
COPY --from=builder --chown=liteinfer:liteinfer /app /app

# Create cache directories
RUN mkdir -p /app/.cache/huggingface /app/.cache/tvm-ffi /app/.cache/flashinfer \
    && chown -R liteinfer:liteinfer /app/.cache
